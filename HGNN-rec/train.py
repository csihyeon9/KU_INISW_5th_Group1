...
from data.data_helper import load_json_data, preprocess_json_for_hgnn, create_keyword_embeddings, preprocess_documents, construct_hypergraph_from_json, analyze_data_distribution
...
def _main():
    ...
    new_hyperedge = {
        "url": "https://www.hankyung.com/article/202410312390i",
        "title": "트라피구라, 인도 6000억 이어 몽골에서 1조5000억원 날렸다 [원자재 포커스]",
        "journalist": "Unknown",
